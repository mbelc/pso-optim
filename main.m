...
%% Question g:
% please go to folder PSOmodif, copy file for the modified algorithm myPSO.m 
% and paste into the main folder (this will replace the original PSO 
% algorithm file)
% re-run previous sections b,e,f


%% Question h:
% please go to folder GA_MIN and run file main.m to obtain the GA results
